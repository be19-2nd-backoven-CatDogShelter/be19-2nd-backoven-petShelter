...
public class PostCommentReportDetailDTO {
    ...
    @Schema(description = "자유게시글 댓글 신고 횟수", example = "1 or 2")
    private int reportCount;

    @Schema(description = "자유게시글 댓글 신고에 대한 키 값", example = "auto_increment이므로 예제가 필요 없음")
    private int id;

    @Schema(description = "자유게시글 댓글 신고 카테고리", example = "SPAM, ETC, MISINFO, PORN, ABUSE")
    private String category;

    @Schema(description = "자유게시글 댓글 신고 기타 내용", example = "드라마 스포를 해요")
    private String etc_detail;

    @Schema(description = "자유게시글 댓글 신고 생성일자", example = "2024-09-02 11:00:00")
    private String created_at;

    @Schema(description = "자유게시글 댓글 신고자", example = "comment_id : 1")
