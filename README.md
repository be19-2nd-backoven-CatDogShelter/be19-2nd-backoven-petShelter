...
![BakeryTeam](https://img.shields.io/badge/Bakery%20Team-FF6961.svg?style=for-the-badge&logo=shopify&logoColor=white)
...
## 🔖 목차
#### [👩🏻‍💻 팀원 소개](#-팀원-소개-1)<br>
#### [🛠 사용한 기술 스택](#-사용한-기술-스택-1)<br>
#### [📢 프로젝트 소개](#-프로젝트-소개-1)<br>
#### [✨ 차별성](#-차별성-1)<br>
#### [📊 WBS](#-wbs-1)<br>
...
#### [📂 논리 모델링](#-논리-모델링-1)<br>
#### [🗺️ ERD](#-erd-1)<br>
#### [🏗️ MSA 아키텍처](#-msa-아키텍처-1)<br>
#### [🧪 테스트 프레임워크 (JUnit)](#-테스트-프레임워크-junit-1)<br>
#### [📜 API 명세서 (Swagger)](#-api-명세서-swagger-1)<br>
#### [🔗 API 테스트 (Postman)](#-api-테스트-postman-1)<br>
#### [📃 프로젝트 회고록](#-프로젝트-회고록-1)<br>

<br>

## 📢 프로젝트 소개
> 댕냥쉼터는 유기견·유기묘 입양과 봉사를 한곳에서 연결하는 커뮤니티형 플랫폼입니다.  
> 보호소 운영 주체(보호소장)와 시민 봉사자가 같은 공간에서 공지·모집·후기·신고·소통을 수행하도록 설계해,  
> 기관과 개인이 함께 운영하는 신뢰 기반 플랫폼을 지향합니다.
...
댕냥쉼터는 **유기동물 보호소와 시민 봉사자, 입양 희망자**를 연결하는 **통합 커뮤니티 플랫폼**입니다.  
단순 입양 정보 제공을 넘어, **보호소 공지·봉사모집·후기공유·신고접수·기부관리**까지 아우르는 서비스를 제공합니다.  
<br>
...
<img width="551" height="245" alt="image" src="https://github.com/user-attachments/assets/1babf266-f190-4cf0-81de-a2b7ae972f11" />
...
<details>
  ...
  <details>
    ...
    <details>
       ...
       <img src="https://github.com/user-attachments/assets/cf16c32a-bd15-4964-9d70-ffba60c215cb"/>
    </details>
    <details>
      <summary>게시글 수정</summary>
      <img src="https://github.com/user-attachments/assets/3a8d5e22-b4c1-4873-81e9-23c94cfa1bc7"/>
    </details>
    <details>
      <summary>게시글 목록 조회</summary>
      <img src="https://github.com/user-attachments/assets/8e7e2ae5-b0ef-4430-b7d5-70cf8b3c88e0"/><br>
      <img src="https://github.com/user-attachments/assets/9053d68c-4b27-47f3-929f-2d93aef5844a"/>
    </details>
    <details>
      <summary>게시글 상세 조회</summary>
      <img src="https://github.com/user-attachments/assets/f7078236-b7cc-4425-ac84-200289ab872b"/>
    </details>
    <details>
...
<details>
  ...
  <details>
    ...
    <details>
      <summary>게시글 작성</summary>
      <img src="https://github.com/user-attachments/assets/a7e17403-00f1-4fb3-81cc-b227b5c0b40d" width="500"/>
    </details>
    <details>
      <summary>게시글 수정</summary>
      <img src="https://github.com/user-attachments/assets/58b763bf-92b8-4031-83cc-dd6dce5c5d3e" width="500"/>
    </details>
    <details>
      <summary>게시글 삭제</summary>
      <img src="https://github.com/user-attachments/assets/f6368030-193e-4b7a-86b2-24f37396a610" width="500"/>
    </details>
    <details>
      <summary>게시글 목록 검색 조회</summary>
      <img src="https://github.com/user-attachments/assets/d89b5c93-15bb-4adb-8447-bf3993f5d0f7" width="500"/>
    </details>
    <details>
      <summary>게시글 목록 페이지 조회</summary>
      <img src="https://github.com/user-attachments/assets/c50e4be5-69f4-495c-9d7e-15123aeee805" width="500"/>
    </details>
    <details>
      <summary>게시글 상세 조회</summary>
      <img src="https://github.com/user-attachments/assets/af39fe89-ca5b-4bd2-ba50-a53dac99fbed" width="500"/>
    </details>
    <details>
      <summary>게시글 좋아요</summary>
      <img src="https://github.com/user-attachments/assets/6c9289b2-3701-4919-9fd0-3f51e32e936c" width="500"/>
    </details>
  </details>
  ...
  <details>
    ...
    <details>
      ...
      <img src="https://github.com/user-attachments/assets/44064ef1-5cc5-427d-bf2f-1460f84ee459" width="500"/>
    </details>
    <details>
      <summary>댓글 삭제</summary>
      <img src="https://github.com/user-attachments/assets/eab86258-0d54-4689-a132-6fc512bb5050" width="500"/>
    </details>
  </details>
  ...
  <details>
    ...
    <details>
      ...
      <img src="https://github.com/user-attachments/assets/90460ed2-1caa-4c4b-9ac3-6cf7f9afbe9d" width="500"/>
    </details>
    <details>
      <summary>댓글 신고하기</summary>
      <img src="https://github.com/user-attachments/assets/eb2c18d5-7843-4097-bea8-1a374c22f894" width="500"/>
    </details>
  </details>
...
<details>
  <summary>🙋🏻‍♀️ 목격제보 게시판 API</summary>
...
| 조원명 | 회고 |
|--------|-------|
| 곽동근  | 이번 프로젝트는 Spring Boot 기반 MVC를 기본으로 하고, DDD설계를 채용하고 CQRS패턴을 적용하여 백엔드 프로젝트를 진행하였는데 프로젝트 주제에 대한 도메인이 여러개 나눠져있어서 열심히 배웠던 내용들을 각자 최대한 활용해서 팀원들이 각자 맡은 모듈에 잘 녹일 수 있었던 것 같다. 그리고 다들 열정적이고 능동적으로 잘 움직이는 사람들이 모여있어서 프로젝트 진행하는동안 일정에 대한 차질도 없었고 서로 모르는 부분들은 보완해가면서 성장하고 프로젝트가 잘 마무리 될 수 있었다. 그리고 프로젝트 거의 끝나갈무렵 security, MSA 아키텍처를 학습 한 후에 설계해서 프로젝트를 확장했는데 어렵고 이해가 안가는 부분들도 있어서 이 부분은 따로 학습을 해보고, 이 부분 외로 시간을 내서 백엔드 공부를 좀 더 해봐야될것같다.그리고 이번 프로젝트 일정에 대한 차질이 없긴했지만 아무래도 빠듯한 일정이였다보니 신경을 못 쓴 부분들에 대해서 트러블슈팅이 발생했었다.트러블슈팅을 겪은 첫번째로는, 처음 패키지 구조 설계할때 구조에 대한 설계뿐만 아니라  각 도메인별로 클래스까지 생성해둔 상태로 패키지 구조를 뿌리고 각자 개발했었는데 각 도메인별로 스프링 컨테이너에 Bean 이름이 등록될때 이름이 겹치면 안되는데 Entity, Controller, repository, Service 클래스 이름들을 전부 같게 해뒀었어서 나중에 모듈을 합쳤을때 쉽지않았었다. 그래도 초반에 회의를 진행하고 각자 맡은 도메인 클래스들 이름을 빠르게 수정해서 바로잡았고 다음으로 겪은문제는 첫번째때 겪은 문제를 나름 빨리 잡았다 생각했었는데 첫번째에 겪은 문제+모두 중간 중간 개발하고 PR날렸어야됐는데 이런 과정들이 많이 없었어서 병합 충돌이 크게 일어났었고 해당 부분들을 수정하는데 시간이 좀 오래 걸리긴했지만 좋은 경험과 큰 깨달음을 얻은 프로젝트 였던것같다. |
| 변민철  | DB프로젝트 이후 본격적인 애플리케이션을 개발하는 경험이었다. 사실 Java문법을 배울 때 까지만해도 객체지향언어가 무엇인지에 대해 크게 와닿지 않았던 것 같다. 특히, 의존성과 같은 용어가 소프트웨어 개발하는 데에 있어서 어떤 의미인지도 감이 오지 않았다. 하지만 스프링을 배우고 나서 점차 '의존성을 주입받는다.', '다른 클래스를 의존한다' 등의 객체지향프로그래밍에서의 다양한 상황을 마주하면서 그 개념을 조금은 깨달은 것 같기도 하다. 이번 프로젝트를 하면서 가장 크게 배운 점은 소위 '뇌 빼고' 개발을 진행한다면 미래에 마주할 에러에 크게 데일 수 있다는 것을 느꼈다. 강사님께서 왜 소프트웨어 개발하는 과정을 건축물에 비유하셨는지가 절실히 느껴졌다. 단순히 IDE 툴을 가지고 자바 코드를 입력하는 행위 자체가 프로그래밍인 줄 알았던 사람이었다. 하지만 단순히 그런 기술적인 작업/업무만이 아닌, 마치 건설을 할 때 설계를 잘하고 하고 토대를 잘 다져놓는 작업을 하는 것처럼 협업을 하면서 팀 내부의 업무/작업의 원칙과 기준을 수립하고 그것을 어떤 방식으로 지켜나갈지를 잘 정하는 것이 중요하다고 느꼈다. 가령 단순하게만 생각했던 Class이름을 서로 협의 없이 임의로 지었다가 Spring Duplicate Bean Definition 문제를 마주했고 그로 인해 다른 패키지나 클래스에 있는 코드를 수정해야했던 경험이 있었다. 이렇게 아주 사소한 것부터 팀 프로젝트 작은 규칙부터 기준까지, 체계를 세우고 프로젝트를 진행하는 것이 가장 중요하다고 생각했다. 물론 기술적인 부분에서 더욱 성장하는 것이 중요했지만, 이번 프로젝트에서 느낀 것은 잘 갖추어진 체계 속에서 원칙을 지키고 개발을 진행하다보면 기술적인 역량은 개발 중 기술적인 필요성에 의해 자연스럽게 따라올 것이라고 생각했다. Mybatis는 Mapper.xml 파일 내 mybatis내 문법을 숙지하고 동적쿼리를 잘 이해하는, 어떻게 보면 sql의 연장선이라고 이해했다. 그리고 Jpa는 시간이 너무 부족한 나머지 추가공부가 필요하다는 것을 절실히 느꼈다. 가볍게 이해한 것은 Entity클래스와 테이블간의 관계, 그리고 persistence context에 대해 조금 더 공부할 필요성을 인지했다. 그리고 JpaRepository의 기능(?) 혹은 개념과 특징을 이해하는 것이 앞으로의 과제를 수행하는 것에 큰 도움이 될 것이라는 성찰을 얻었다. 결론, 기술적인 내용이 아닌 소프트웨어 개발 전 프로세스에 대한 충분한 개념과 이해가 필요하다는 것이 이번 프로젝트의 가장 큰 깨달음이 아닐까 싶다. |
| 이승건  | 이번 프로젝트는 유기동물 커뮤니티 백엔드 개발을 목표로 진행하였다. 아키텍처는 CQRS 패턴을 적용하여 Query 파트는 MyBatis로, Command 파트는 JPA로 구현하였다. REST API를 지향하며 메소드의 기능에 맞게 매핑을 진행했으나, URL 명칭까지 완전히 RESTful하게 적용하지 못한 점은 아쉬움으로 남는다. 프로젝트 초기에 DDD 설계를 진행한 덕분에 개발 과정에서 흐름을 놓치지 않고 팀원들과 원활하게 소통할 수 있었다. 도메인 언어를 통일함으로써 개발 방향성을 공유하는 것이 얼마나 중요한지 체감할 수 있었다. DDD 기반으로 여러 종류의 게시판이 도출되었고, 팀원 모두가 DB-Java CRUD 경험을 쌓을 수 있도록 각자 하나 이상의 게시판을 맡았다. 나는 목격 정보 게시판, 등급·봉사왕 기능, 쪽지 기능을 담당하였다. 기능 분배 당시에는 게시판 외의 기능을 맡고 싶어 자발적으로 선택했지만, 상대적으로 가벼운 기능이어서 다른 게시판을 맡아볼 걸 하는 아쉬움도 있었다. 협업 과정에서는 규칙 부재로 인해 클래스명이나 파일명 충돌이 빈번하게 발생했다. 이를 해결하기 위해 도메인명을 접두사로 붙이는 방식을 사용했지만, 애초에 규칙을 정하지 않은 것이 문제의 원인이었다. 이 경험을 통해 DDD와 같은 설계 방식이 팀의 언어를 통일하고 방향성을 잡는 데 중요하다는 점, 그리고 협업을 위한 명확한 규칙 설정이 필수적이라는 점을 배울 수 있었다. |
| 이지윤  | 이번 프로젝트에서는 자유게시판과 보호소장 파트를 담당하였다. 자유게시판의 경우, MyBatis를 사용하여 조회 기능을 구현하고, JPA를 활용해 데이터 삽입·수정·삭제를 처리하였다. 조회에는 MyBatis를 택한 이유가, 직접 SQL 쿼리를 작성함으로써 원하는 조건과 조인을 세밀하게 표현할 수 있었기 때문이다. 반면 JPA는 엔티티 기반으로 매핑해두면 기본적인 CRUD 쿼리를 자동 생성해주어 생산성이 높아, 삽입·수정·삭제에 적합했다. 다만, 두 기술을 혼합하다 보니 SQL 직접 작성 시 파라미터 매핑 오류가 발생하거나, 엔티티 설계 변경 시 JPA 쿼리가 의도와 다르게 생성되는 문제가 있었다. 이를 해결하기 위해, MyBatis는 Mapper XML에서 파라미터 이름과 DTO 필드명을 일치시키도록 규칙을 정했고, JPA는 @Query와 로깅을 병행하여 실제 실행되는 SQL을 확인하며 디버깅하였다. 보호소장 파트에서는 로그인 요청과 응답에 다른 DTO를 사용하여, 최초 로그인 시 JWT 토큰을 발급하고 이후 요청은 토큰 기반 인증으로 처리하도록 설계하였다. 또한 Spring Security를 적용해 회원 권한에 따라 접근 가능한 기능을 제한하였다. MSA 구조를 도입하여 모듈별 유지보수성을 높였으며, 일반 회원과 보호소장 회원의 Bean 충돌 문제는 클래스명에 접두사/접미사를 부여해 빈 이름을 구분함으로써 해결했다. 기능 테스트 중에는 권한 문제(HTTP 403)가 잦았는데, 이때는 Config 설정에서 permitAll()을 임시로 열어 기능만 검증한 뒤, 최종 병합 시 권한 정책을 다시 적용하는 방식을 사용했다. 또 GitHub 협업 과정에서 PR 병합 충돌이 빈번히 발생했는데, 이를 줄이기 위해 프로젝트 구조를 미리 문서화하고, 기능 개발 후 즉시 PR을 올리는 규칙을 팀 내에서 합의하여 문제를 해결하였다. |
| 최혜원  | 저는 이번 프로젝트에서 입양게시판 기능과 회원 관리 기능을 담당했습니다. 처음에는 단순히 CRUD 형태의 기능을 구현하는 것이 목표였지만, 실제로 개발을 진행하다 보니 사용자의 입장에서 어떤 흐름으로 서비스를 이용할지, 또 서비스가 어떤 데이터를 제공해야 사이트의 신뢰성을 확보할 수 있을지 고민이 많았습니다. 회원 관리 부분에서는 일반 회원과 보호소장 회원을 구분하는 것이 중요한 포인트였습니다. 보호소장은 봉사 모임을 직접 관리할 수 있고, 일반 회원은 로그인을 한 뒤 토큰을 통해 게시판을 조회하고 봉사 모임을 신청하거나 게시글 작성과 댓글·신고 기능을 사용할 수 있습니다. 이런 권한 분리를 구현하기 위해 Spring Security와 JWT 기반 인증/인가를 적용했습니다. 세션 기반 인증과 달리 JWT는 서버에 상태를 저장하지 않고도 인증을 유지할 수 있기 때문에, 실제 서비스에서 널리 사용되는 방식을 직접 적용해보며 많은 것을 배웠습니다. 입양게시판은 프로젝트에서 가장 사용자 친화적인 기능 중 하나였습니다. 보호소장이 직접 등록한 공고뿐만 아니라 개인 간 분양 공고도 올릴 수 있도록 하였고, 사용자는 이를 전체 조회, 상세 조회, 조건 검색(제목, 내용, 동물 상태 등)을 통해 찾을 수 있습니다. 단순히 리스트를 보여주는 것에서 끝나는 것이 아니라, 인기 있는 글을 빠르게 확인할 수 있도록 조회순·추천순 정렬 기능을 추가했고, 게시글마다 댓글과 신고 기능을 넣어 사용자 참여와 커뮤니티성을 강화했습니다. 특히 조건 검색 기능을 구현하면서 다양한 필터 조합을 어떻게 효율적으로 처리할지 고민하게 되었고, 이는 SQL 최적화와 Mybatis의 동적 쿼리에 대한 이해도를 높이는 계기가 되었습니다. 이번 프로젝트를 통해 사용자 권한에 따라 다른 흐름을 설계하는 것, 데이터베이스와 서비스 로직을 긴밀하게 연결하는 것, 실제 사용자가 어떤 상황에서 어떤 데이터를 필요로 할지 고민하는 것의 중요성을 배웠습니다. 또한, 혼자만의 코드가 아니라 팀원들과 연결되는 서비스의 일부를 맡아 개발하다 보니, 제 코드가 전체 시스템에서 어떤 의미를 가지는지도 더 깊이 생각하게 되었습니다. 앞으로도 이런 경험을 바탕으로, 서비스의 가치와 의미를 깊이 고민하며, 사용자에게 더 쉽고 접근성 높은 방식으로 다가가는 개발자가 되고자 합니다. |
...
| 동료명 | 평가 내용 |
|--------|-----------|
| 변민철 | 프로젝트를 팀원들 모두가 주제에 대한 기능을 구상할때 무수히 많은 아이디어를 제공해주신 덕에 프로젝트를 잘 마무리한 것 같습니다. 그리고 프로젝트 진행하는 처음부터 끝까지 문제없이 꼼꼼히 체크하시는 부분들때문에 모두가 상호보완이 잘 됐고, 본인이 맡은 부분에 대해서 잘 안되고 모자란부분들은 일정내에 따로 학습하며 완성하시고 열정과 최선을 다해 마무리 하는 모습, 그리고 추 후 학습을 위해 노트에 필기까지 하시는 모습은 굉장히 멋잇고 인상 깊었고 이런 태도들이 단순히 개인의 성장만을 위한것이 아니라 팀 전체에도 긍정적으로 영향이 끼쳤으며 책임감있는 모습들이 모두에게 큰 신뢰를 주었다 생각합니다. |
| 이승건 | 실제 기능 개발과 관련된 부분에서 논리적으로 접근하여 기능이 완전하게 구현될 수 있도록 하는 발판이 되어주셨습니다. 팀원들끼리 모여서 회의를하고 질문을 할때 성실하게 피드백을 해주면서 팀원들의 성장에 기여를 많이 해주셨습니다. 회의했을때 의견들을 단순히 수용하는데 그치지않고 본인의 논리적인 생각을 설득력있게 제시하여 팀 내 의사결정 과정에서도 긍정적인 영향을 주셔서 프로젝트의 완성도도 한층 높아졌습니다. 또한 맡은 역할을 꼼꼼하게 수행하며 다른 팀원들의 어려움을 함께 고민해주는 모습은 팀 전체에 큰 신뢰를 주었고 이를 바탕으로 프로젝트의 안정성과 신뢰성을 높이는데 중요한 역할을 담당해주셨습니다. |
| 이지윤 | 로젝트를 진행하면서 어떤 역할이든 적극적으로 수행하려는 자세를 보여주셔서 든든했고, 맡은 업무에 대해 끝까지 책임지고자 하는 성실함이 많이 돋보였습니다. 프로젝트 진행 중간중간마다 큰 흐름들을 놓치지 않기 위해서 스스로 질문하면서 확인하는 모습은 팀 전체가 같은 방향성을 유지하는게 큰 도움이 되었습니다. 마지막까지도 성실하게 임하며 팀원들이랑 소통하고 팀원들이 어려움에 빠졌을때 같이 고민하고 의견을 나눠주는 모습에서 진정성을 느꼈으며 이런 태도라면 어떤 프로젝트에서라도 큰 성과를 만들어 낼 수 있을거라 생각합니다. |
| 최혜원 | 팀원들이 선뜻 나서지 않은 부분들에 대해서 스스로 나서서 책임감을 갖고 해결하며 ppt 발표자료와 프로젝트 문서화를 거의 전담하다시피 맡아주셔서 팀 전체의 부담을 덜어주셨습니다. 나서서 하는게 쉬운 선택이 아니기도 하고 본인이 맡은 파트에 대한 일정도 빠듯할텐데 시간내에 본인 일정까지 발 빠르게 마무리하고 문서 작업까지 소화해내시는 모습이 인상적이였습니다. 특히 문서화 과정에서 핵심 내용들을 명확하게 정리해주셔서 프로젝트에 대한 가독성, 완성도를 크게 높이는데 많이 기여해주셨습니다. 주도성과 책임감있는 성실함 덕분에 프로젝트가 원활히 진행될 수 있었습니다. |

###  Peer Review 작성자 : 변민철
| 동료명 | 평가 내용 |
|--------|-----------|
| 곽동근 | 사소하거나 작은 어려움이 있을 때 적극적으로 도와주셔서 개발할 때 많은 도움이 되었습니다. 그리고 프로젝트를 진행을 막힘없이 진행하는데 큰 역할을 하셨습니다. 가령, 선택의 기로에 있을때, 적절한 옵션들을 논리적으로 근거를 제시하여 제안하여 안정적으로 프로젝트를 진행할 수 있었습니다. 또한, 깃허브 프로젝트를 열거나, 협업을 위한 툴들을 미리 할당해서 개발하면서 협업이 원활히 될 수 있도록 하였습니다. |
| 이승건 | 실제 기능 개발과 관련된 부분에서 논리적으로 접근하여 기능이 완전하게 구현될 수 있도록 하는 발판이 되어주었습니다. 특히, 트랜잭션에 대한 고민을 가지고 기능 개발에 접근하여 DB에서부터 백엔드단에서의 기능 개발에 중요한 역할을 수행했습니다. 특히, 우리 팀의 애플리케이션에서 주요기능 중 하나인 이달의 봉사왕을 표시하는 기능을 개발하는데 있어서 월마다 봉사횟수를 초기화 시키는 이벤트를 발생시키는 기능을 개발하는 부분에서 기술적으로 큰 역할을 하였습니다. 또한, 가장 먼저 기능을 개발을 마치고 팀원들의 어려움이나 개발의 완성도를 높이는 작업을 수행하였습니다. |
| 이지윤 | 프로젝트를 같이 하면서 어려운 부분이 많았던 것 같았지만, 기능을 개발하여 프로젝트를 완성하여 극복하는 모습이 본받을 만한 지점이었습니다. 그리고, 어떤 역할이든 적극적으로 수행하려는 모습이 팀원으로서, 신뢰할 수 있는 태도로 보였습니다. 그리고 프로젝트 중간마다 큰 흐름을 놓치지 않으려고 질문을 통해 인지할 때 함께 흐름을 놓치지 않는데에 크게 도움이 되었습니다. |
| 최혜원 | 우리 팀프로젝트의 주제를 정하고 중요한 문서작업이나 기술개발의 방향성을 제시하여 프로젝트를 시작하는데 중요한 역할을 하였습니다. 또한 협업 시 필요한 툴과 발표 준비를 위한 자료 등, 누군가는 기술개발외에 필요한 작업들을 자발적으로, 적극적으로 수행하며, 다른 팀원들의 부담을 덜어주는 역할을 하였습니다. 또한, 가장 개발 난도가 어렵다고 예상한 security를 적용을 가장 먼저 나서서 자처하여 개발의 완성도를 높여주었습니다. 조용히 누구보다 많은 역할을 주도적으로 하여 프로젝트가 원활하게 진행되도록 해주었습니다. |

###  Peer Review 작성자 : 이승건
| 동료명 | 평가 내용 |
|--------|-----------|
| 곽동근 | 프로젝트 진행 과정에서 항상 팀 분위기를 긍정적으로 이끌어 주셨습니다. 개발 도중 막히는 부분이 생기면 직접 해결 방법을 찾아주시거나 함께 고민해 주셔서 많은 도움을 받을 수 있었습니다. 또한 자신의 업무만 신경 쓰는 것이 아니라 팀 전체의 진행 상황을 살피며 부족한 부분을 보완해 주셨습니다. 특히 코드 리뷰 과정에서 단순히 맞다/틀리다의 피드백을 주는 것이 아니라, 왜 그런 접근이 더 좋은지에 대한 이유를 설명해 주셔서 이해도를 높일 수 있었습니다. 의견을 제시할 때에도 상대방의 관점을 존중하며 설득력 있게 전달하셔서 팀원들이 안심하고 따라갈 수 있었습니다. 이러한 태도 덕분에 프로젝트가 안정적으로 마무리될 수 있었다고 생각합니다. |
| 변민철 | 개발 과정에서 항상 꼼꼼하게 기능을 점검하고 세부적인 부분까지 신경 쓰는 모습을 보여주셨습니다. 기능 구현 중 의문이 생기면 단순히 넘어가지 않고 그 이유를 명확히 짚어내며 팀원들과 함께 논의해 해결해 나가는 태도가 인상적이었습니다. 맡은 역할에 책임감을 가지고 최선을 다했으며, 기존 방법이 잘 작동하지 않을 때에도 새로운 대안을 모색하며 문제 상황을 적극적으로 해결하셨습니다. 특히 게시판 중 가장 난이도가 높은 파트를 맡고도 불만 없이 끝까지 완수하는 모습을 통해 성실함과 책임감을 느낄 수 있었습니다. |
| 이지윤 | 프로젝트 진행 중 어려움이 있었음에도 끝까지 기능을 완성해내는 모습을 통해 책임감과 끈기를 느낄 수 있었습니다. 맡은 역할에만 머물지 않고 필요한 부분이 있다면 적극적으로 나서 주어 팀원으로서 큰 신뢰를 주셨습니다. 제가 프로젝트의 흐름을 놓친 것 같아 질문을 드렸을 때에도, 본인의 작업이 지연될 수 있음에도 불구하고 열정적으로 답변해 주시며 함께 토론해 주신 점이 인상 깊었습니다.  |
| 최혜원 | 프로젝트 전반에서 기술적인 부분뿐만 아니라 비개발적인 부분까지 적극적으로 챙겨주셨습니다. 또한 팀원들이 어려워하는 부분을 먼저 시도하며 해결책을 제시해 주어 프로젝트의 완성도를 높이는 데 크게 기여하셨습니다. 문서 작성과 발표 자료 준비에도 많은 노력을 기울여 주셔서, 단순히 기능 구현을 넘어 프로젝트 결과물을 체계적으로 정리할 수 있었습니다. 항상 팀원의 의견을 존중하며 최적의 방안을 함께 찾는 태도 덕분에 협업 과정이 원활했고, 프로젝트 전반에서 큰 신뢰를 주는 팀원이었습니다. |

###  Peer Review 작성자 : 이지윤
| 동료명 | 평가 내용 |
|--------|-----------|
| 곽동근 | 팀원들의 질문사항에 항상 진지하게 답변해주시고, 여러 의견들을 대한 피드백을 제시해 프로젝트의 방향성이 높이게 해 주셨습니다. 자기가 맡은 분야에 대해 자기가 생각했을 때 더 나은 방식으로 기능을 업그레이드 시켜 다른 기능들과의 차별성을 두었습니다. 발표 할 당시 제가 답하지 못한 곤란한 부분에 대해서 답해주시고 의견 충돌이 있을 경우에도 자신의 생각을 명확하게 말씀하시고 다른 사람들의 의견을 적극 수용하셨습니다. |
| 변민철 | 여러 기능 개발할 당시 세세하고 꼼꼼하게 생각하시는 모습을 보였습니다. 한 기능에 대해서 의문이 들 경우 왜 이 의문이 들었는지 정확하게 물어보시고 다른 사름들의 의견을 나누면서 해결해 나가는 모습을 보였습니다. 자신이 맡은 분야에 대해서 최선을 다하시고 기존의 방식이 안 될 경우 다른 방안을 마련하셔 문제인 상황에 대처하려는 모습이 보였습니다. |
| 이승건 | 코드 개발 당시 제가 한 질문에 대해서 많은 피드백을 주셨습니다. 코드의 전체 흐름과 세세한 부분에 대하여 자세히 아시고, 코드 개발 중 변경사항에 관한 대처가 굉장히 유연합니다. 기능 개발 당시 남들이 신경 안 쓸수도 있는 치밀한 부분까지 계산하여 개발에 임하셨고, 다른 팀원들이 의견을 수용하는 것 뿐만 아니라 자신의 생각을 설득하는 모습을 보였습니다. |
| 최혜원 | 저와 유사한 기능을 개발하시면서 마지막에 제가 한 실수를 깔끔하게 정리하시는 모습을 통해 코드 분석 능력과 상황을 해결하려는 능력이 뛰어났습니다. 문서 작업의 많은 부분을 도맡아 하시고, ppt 발표 자료를 준비를 거의 다 하시는 점에서 개발자에게 필요한 문서 작업 능력이 굉장히 뛰어났습니다. 다른 팀원들의 의견을 적극 수용하여 보다 더 나은 프로젝트를 진행하시는 모습을 보였습니다. |

### Peer Review 작성자 : 최혜원
| 동료명 | 평가 내용 |
|--------|-----------|
| 곽동근 | 동근님은 프로젝트 초반부터 협업 툴과 깃허브 환경을 준비하고 문서화 작업을 체계적으로 시작해주셔서 팀원들이 원활하게 개발에 집중할 수 있는 기반을 마련해주셨습니다. 프로젝트 진행 중 의사결정이 필요한 순간마다 다양한 선택지를 논리적으로 제시하며 설득력 있게 의견을 이끌어 주셔서 안정적인 흐름을 유지할 수 있었습니다. 또한 ERD 설계 과정에서 전반적인 구조를 검토하고 세부적인 부분까지 보완해주셔서 데이터베이스의 완성도가 크게 높아졌습니다. 단순한 기능 구현에 머무르지 않고 협업 환경 조성, 핵심 기능 구현, ERD 설계, 문서화 등 다양한 방면에서 주도적으로 기여하며 프로젝트가 흔들리지 않고 높은 완성도로 마무리될 수 있었습니다. |
| 변민철 | 민철님은 봉사모임, 봉사후기, 공지게시판을 구현하며 서비스의 핵심 커뮤니티 기능을 안정적으로 완성해주셨습니다. 단순한 글 작성과 조회를 넘어서 사용자 경험을 고려한 구조를 마련해 프로젝트의 완성도를 크게 높였습니다. 초반 회의에서부터 적극적으로 의견을 제시하며 팀의 방향성을 잡아주셨고, 논리적인 근거를 바탕으로 설득하여 팀의 합의가 원활히 이루어질 수 있도록 도와주셨습니다. 특히 논리모델링 단계에서 데이터 구조의 뼈대를 잡아주신 점은 전체 개발에 큰 기여가 되었고, ERD 설계에서도 팀원들이 놓친 부분을 짚어주셔서 더욱 견고한 결과물이 나올 수 있었습니다. 기능 구현뿐 아니라 설계와 의사결정 전반에서 적극적인 역할을 수행하셨습니다. |
| 이승건 | 승건님은 목격제보 게시판, 회원 관련 기능, 이벤트 스케줄러와 트리거를 구현해 서비스가 실제로 운영 가능한 수준으로 발전하는 데 큰 기여를 하셨습니다. 단순 CRUD 기능을 넘어, 신고 누적 시 블라인드 처리나 봉사왕 집계 같은 자동화 로직을 구축하여 서비스의 신뢰성과 실용성을 높였습니다. 또한 이벤트 스케줄러를 통해 월별 봉사 횟수 초기화 등 주기적인 작업을 자동화하여 관리자의 개입 없이도 안정적인 서비스 운영이 가능하게 만들었습니다. 논리모델링 과정에서도 데이터 구조와 관계를 명확히 정의해 개발의 토대를 마련하셨고, 전체 모델을 일관되게 다듬어주셔서 프로젝트의 구조적 안정성이 크게 강화되었습니다. 코드 흐름과 구조를 깊이 이해하고 계셔서 팀원들의 질문에도 명확히 답하며 품질을 끌어올리는 핵심적인 역할을 해주셨습니다. |
| 이지윤 | 지윤님은 보호소장 회원 기능과 자유게시판을 구현하셨습니다. 보호소장 회원 기능을 통해 서비스에 공신력을 더했고, 자유게시판을 통해 회원들이 자유롭게 의견을 나눌 수 있는 공간을 마련해 활용성을 높였습니다. 프로젝트 초반 회의에서 중간 내용을 정리해주셔서 회의가 산만해지지 않고 명확한 방향성을 유지할 수 있었고, 필요할 때는 적절한 질문을 통해 합의점을 이끌어내며 팀의 흐름을 안정적으로 잡아주셨습니다. 또한 승건님과 함께 패키지 구조를 고민하고 정리하여 코드가 일관성과 유지보수성을 갖추도록 크게 기여하셨습니다. 마지막으로 발표를 직접 맡아 차분하고 명확한 설명으로 프로젝트의 성과를 외부에 잘 전달하며 팀을 대표해주셨습니다. |
