...
| 평가자 | 평가 내용 |
|--------|-----------|
| 변민철 | 사소하거나 작은 어려움이 있을 때 적극적으로 도와주셔서 개발할 때 많은 도움이 되었습니다. 그리고 프로젝트를 진행을 막힘없이 진행하는데 큰 역할을 하셨습니다. 가령, 선택의 기로에 있을때, 적절한 옵션들을 논리적으로 근거를 제시하여 제안하여 안정적으로 프로젝트를 진행할 수 있었습니다. 또한, 깃허브 프로젝트를 열거나, 협업을 위한 툴들을 미리 할당해서 개발하면서 협업이 원활히 될 수 있도록 하였습니다. |
| 이승건 | 프로젝트 진행 과정에서 항상 팀 분위기를 긍정적으로 이끌어 주셨습니다. 개발 도중 막히는 부분이 생기면 직접 해결 방법을 찾아주시거나 함께 고민해 주셔서 많은 도움을 받을 수 있었습니다. 또한 자신의 업무만 신경 쓰는 것이 아니라 팀 전체의 진행 상황을 살피며 부족한 부분을 보완해 주셨습니다. 특히 코드 리뷰 과정에서 단순히 맞다/틀리다의 피드백을 주는 것이 아니라, 왜 그런 접근이 더 좋은지에 대한 이유를 설명해 주셔서 이해도를 높일 수 있었습니다. 의견을 제시할 때에도 상대방의 관점을 존중하며 설득력 있게 전달하셔서 팀원들이 안심하고 따라갈 수 있었습니다. 이러한 태도 덕분에 프로젝트가 안정적으로 마무리될 수 있었다고 생각합니다.|
| 이지윤 | 팀원들의 질문사항에 항상 진지하게 답변해주시고, 여러 의견들을 대한 피드백을 제시해 프로젝트의 방향성이 높이게 해 주셨습니다. 자기가 맡은 분야에 대해 자기가 생각했을 때 더 나은 방식으로 기능을 업그레이드 시켜 다른 기능들과의 차별성을 두었습니다. 발표 할 당시 제가 답하지 못한 곤란한 부분에 대해서 답해주시고 의견 충돌이 있을 경우에도 자신의 생각을 명확하게 말씀하시고 다른 사람들의 의견을 적극 수용하셨습니다. |
| 최혜원 | 동근님은 프로젝트 초반부터 협업 툴과 깃허브 환경을 준비하고 문서화 작업을 체계적으로 시작해주셔서 팀원들이 원활하게 개발에 집중할 수 있는 기반을 마련해주셨습니다. 프로젝트 진행 중 의사결정이 필요한 순간마다 다양한 선택지를 논리적으로 제시하며 설득력 있게 의견을 이끌어 주셔서 안정적인 흐름을 유지할 수 있었습니다. 또한 ERD 설계 과정에서 전반적인 구조를 검토하고 세부적인 부분까지 보완해주셔서 데이터베이스의 완성도가 크게 높아졌습니다. 단순한 기능 구현에 머무르지 않고 협업 환경 조성, 핵심 기능 구현, ERD 설계, 문서화 등 다양한 방면에서 주도적으로 기여하며 프로젝트가 흔들리지 않고 높은 완성도로 마무리될 수 있었습니다. |

###   변민철
| 평가자 | 평가 내용 |
|--------|-----------|
| 곽동근 | 프로젝트를 팀원들 모두가 주제에 대한 기능을 구상할때 무수히 많은 아이디어를 제공해주신 덕에 프로젝트를 잘 마무리한 것 같습니다. 그리고 프로젝트 진행하는 처음부터 끝까지 문제없이 꼼꼼히 체크하시는 부분들때문에 모두가 상호보완이 잘 됐고, 본인이 맡은 부분에 대해서 잘 안되고 모자란부분들은 일정내에 따로 학습하며 완성하시고 열정과 최선을 다해 마무리 하는 모습, 그리고 추 후 학습을 위해 노트에 필기까지 하시는 모습은 굉장히 멋잇고 인상 깊었고 이런 태도들이 단순히 개인의 성장만을 위한것이 아니라 팀 전체에도 긍정적으로 영향이 끼쳤으며 책임감있는 모습들이 모두에게 큰 신뢰를 주었다 생각합니다. |
| 이승건 | 개발 과정에서 항상 꼼꼼하게 기능을 점검하고 세부적인 부분까지 신경 쓰는 모습을 보여주셨습니다. 기능 구현 중 의문이 생기면 단순히 넘어가지 않고 그 이유를 명확히 짚어내며 팀원들과 함께 논의해 해결해 나가는 태도가 인상적이었습니다. 맡은 역할에 책임감을 가지고 최선을 다했으며, 기존 방법이 잘 작동하지 않을 때에도 새로운 대안을 모색하며 문제 상황을 적극적으로 해결하셨습니다. 특히 게시판 중 가장 난이도가 높은 파트를 맡고도 불만 없이 끝까지 완수하는 모습을 통해 성실함과 책임감을 느낄 수 있었습니다. |
| 이지윤 | 여러 기능 개발할 당시 세세하고 꼼꼼하게 생각하시는 모습을 보였습니다. 한 기능에 대해서 의문이 들 경우 왜 이 의문이 들었는지 정확하게 물어보시고 다른 사름들의 의견을 나누면서 해결해 나가는 모습을 보였습니다. 자신이 맡은 분야에 대해서 최선을 다하시고 기존의 방식이 안 될 경우 다른 방안을 마련하셔 문제인 상황에 대처하려는 모습이 보였습니다. |
| 최혜원 | 민철님은 봉사모임, 봉사후기, 공지게시판을 구현하며 서비스의 핵심 커뮤니티 기능을 안정적으로 완성해주셨습니다. 단순한 글 작성과 조회를 넘어서 사용자 경험을 고려한 구조를 마련해 프로젝트의 완성도를 크게 높였습니다. 초반 회의에서부터 적극적으로 의견을 제시하며 팀의 방향성을 잡아주셨고, 논리적인 근거를 바탕으로 설득하여 팀의 합의가 원활히 이루어질 수 있도록 도와주셨습니다. 특히 논리모델링 단계에서 데이터 구조의 뼈대를 잡아주신 점은 전체 개발에 큰 기여가 되었고, ERD 설계에서도 팀원들이 놓친 부분을 짚어주셔서 더욱 견고한 결과물이 나올 수 있었습니다. 기능 구현뿐 아니라 설계와 의사결정 전반에서 적극적인 역할을 수행하셨습니다. |

###   이승건
| 평가자 | 평가 내용 |
|--------|-----------|
| 곽동근 |  팀원들끼리 모여서 회의를하고 질문을 할때 성실하게 피드백을 해주면서 팀원들의 성장에 기여를 많이 해주셨습니다. 그리고 회의했을때 의견들을 단순히 수용하는데 그치지않고 본인의 논리적인 생각을 설득력있게 제시하여 팀 내 의사결정 과정에서도 긍정적인 영향을 주셔서 프로젝트의 완성도도 한층 높아졌습니다. 또한 맡은 역할을 꼼꼼하게 수행하며 다른 팀원들의 어려움을 함께 고민해주는 모습은 팀 전체에 큰 신뢰를 주었고 이를 바탕으로 프로젝트의 안정성과 신뢰성을 높이는데 중요한 역할을 담당해주셨습니다. |
| 변민철 | 실제 기능 개발과 관련된 부분에서 논리적으로 접근하여 기능이 완전하게 구현될 수 있도록 하는 발판이 되어주었습니다. 특히, 트랜잭션에 대한 고민을 가지고 기능 개발에 접근하여 DB에서부터 백엔드단에서의 기능 개발에 중요한 역할을 수행했습니다. 특히, 우리 팀의 애플리케이션에서 주요기능 중 하나인 이달의 봉사왕을 표시하는 기능을 개발하는데 있어서 월마다 봉사횟수를 초기화 시키는 이벤트를 발생시키는 기능을 개발하는 부분에서 기술적으로 큰 역할을 하였습니다. 또한, 가장 먼저 기능을 개발을 마치고 팀원들의 어려움이나 개발의 완성도를 높이는 작업을 수행하였습니다. |
| 이지윤 | 코드 개발 당시 제가 한 질문에 대해서 많은 피드백을 주셨습니다. 코드의 전체 흐름과 세세한 부분에 대하여 자세히 아시고, 코드 개발 중 변경사항에 관한 대처가 굉장히 유연합니다. 기능 개발 당시 남들이 신경 안 쓸수도 있는 치밀한 부분까지 계산하여 개발에 임하셨고, 다른 팀원들이 의견을 수용하는 것 뿐만 아니라 자신의 생각을 설득하는 모습을 보였습니다. |
| 최혜원 | 승건님은 목격제보 게시판, 회원 관련 기능, 이벤트 스케줄러와 트리거를 구현해 서비스가 실제로 운영 가능한 수준으로 발전하는 데 큰 기여를 하셨습니다. 단순 CRUD 기능을 넘어, 신고 누적 시 블라인드 처리나 봉사왕 집계 같은 자동화 로직을 구축하여 서비스의 신뢰성과 실용성을 높였습니다. 또한 이벤트 스케줄러를 통해 월별 봉사 횟수 초기화 등 주기적인 작업을 자동화하여 관리자의 개입 없이도 안정적인 서비스 운영이 가능하게 만들었습니다. 논리모델링 과정에서도 데이터 구조와 관계를 명확히 정의해 개발의 토대를 마련하셨고, 전체 모델을 일관되게 다듬어주셔서 프로젝트의 구조적 안정성이 크게 강화되었습니다. 코드 흐름과 구조를 깊이 이해하고 계셔서 팀원들의 질문에도 명확히 답하며 품질을 끌어올리는 핵심적인 역할을 해주셨습니다. |

###   이지윤
| 평가자 | 평가 내용 |
|--------|-----------|
| 곽동근 | 프로젝트를 진행하면서 어떤 역할이든 적극적으로 수행하려는 자세를 보여주셔서 든든했고, 맡은 업무에 대해 끝까지 책임지고자 하는 성실함이 많이 돋보였습니다. 프로젝트 진행 중간중간마다 큰 흐름들을 놓치지 않기 위해서 스스로 질문하면서 확인하는 모습은 팀 전체가 같은 방향성을 유지하는게 큰 도움이 되었습니다. 마지막까지도 성실하게 임하며 팀원들이랑 소통하고 팀원들이 어려움에 빠졌을때 같이 고민하고 의견을 나눠주는 모습에서 진정성을 느꼈으며 이런 태도라면 어떤 프로젝트에서라도 큰 성과를 만들어 낼 수 있을거라 생각합니다. |
| 변민철 | 프로젝트를 같이 하면서 어려운 부분이 많았던 것 같았지만, 기능을 개발하여 프로젝트를 완성하여 극복하는 모습이 본받을 만한 지점이었습니다. 그리고, 어떤 역할이든 적극적으로 수행하려는 모습이 팀원으로서, 신뢰할 수 있는 태도로 보였습니다. 그리고 프로젝트 중간마다 큰 흐름을 놓치지 않으려고 질문을 통해 인지할 때 함께 흐름을 놓치지 않는데에 크게 도움이 되었습니다.  |
| 이승건 | 프로젝트 진행 중 어려움이 있었음에도 끝까지 기능을 완성해내는 모습을 통해 책임감과 끈기를 느낄 수 있었습니다. 맡은 역할에만 머물지 않고 필요한 부분이 있다면 적극적으로 나서 주어 팀원으로서 큰 신뢰를 주셨습니다. 제가 프로젝트의 흐름을 놓친 것 같아 질문을 드렸을 때에도, 본인의 작업이 지연될 수 있음에도 불구하고 열정적으로 답변해 주시며 함께 토론해 주신 점이 인상 깊었습니다.  |
...
| 평가자 | 평가 내용 |
|--------|-----------|
| 곽동근 | 팀원들이 선뜻 나서지 않은 부분들에 대해서 스스로 나서서 책임감을 갖고 해결하며 ppt 발표자료와 프로젝트 문서화를 거의 전담하다시피 맡아주셔서 팀 전체의 부담을 덜어주셨습니다. 나서서 하는게 쉬운 선택이 아니기도 하고 본인이 맡은 파트에 대한 일정도 빠듯할텐데 시간내에 본인 일정까지 발 빠르게 마무리하고 문서 작업까지 소화해내시는 모습이 인상적이였습니다. 특히 문서화 과정에서 핵심 내용들을 명확하게 정리해주셔서 프로젝트에 대한 가독성, 완성도를 크게 높이는데 많이 기여해주셨습니다. 주도성과 책임감있는 성실함 덕분에 프로젝트가 원활히 진행될 수 있었습니다. |
| 변민철 | 우리 팀프로젝트의 주제를 정하고 중요한 문서작업이나 기술개발의 방향성을 제시하여 프로젝트를 시작하는데 중요한 역할을 하였습니다. 또한 협업 시 필요한 툴과 발표 준비를 위한 자료 등, 누군가는 기술개발외에 필요한 작업들을 자발적으로, 적극적으로 수행하며, 다른 팀원들의 부담을 덜어주는 역할을 하였습니다. 또한, 가장 개발 난도가 어렵다고 예상한 security를 적용을 가장 먼저 나서서 자처하여 개발의 완성도를 높여주었습니다. 조용히 누구보다 많은 역할을 주도적으로 하여 프로젝트가 원활하게 진행되도록 해주었습니다. |
| 이승건 | 프로젝트 전반에서 기술적인 부분뿐만 아니라 비개발적인 부분까지 적극적으로 챙겨주셨습니다. 또한 팀원들이 어려워하는 부분을 먼저 시도하며 해결책을 제시해 주어 프로젝트의 완성도를 높이는 데 크게 기여하셨습니다. 문서 작성과 발표 자료 준비에도 많은 노력을 기울여 주셔서, 단순히 기능 구현을 넘어 프로젝트 결과물을 체계적으로 정리할 수 있었습니다. 항상 팀원의 의견을 존중하며 최적의 방안을 함께 찾는 태도 덕분에 협업 과정이 원활했고, 프로젝트 전반에서 큰 신뢰를 주는 팀원이었습니다. |
| 이지윤 | 저와 유사한 기능을 개발하시면서 마지막에 제가 한 실수를 깔끔하게 정리하시는 모습을 통해 코드 분석 능력과 상황을 해결하려는 능력이 뛰어났습니다. 문서 작업의 많은 부분을 도맡아 하시고, ppt 발표 자료를 준비를 거의 다 하시는 점에서 개발자에게 필요한 문서 작업 능력이 굉장히 뛰어났습니다. 다른 팀원들의 의견을 적극 수용하여 보다 더 나은 프로젝트를 진행하시는 모습을 보였습니다. |
