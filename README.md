...
| 최혜원 | 민철님은 봉사모임, 봉사후기, 공지게시판을 구현하며 서비스의 핵심 기능을 안정적으로 완성해주셨습니다. 초반 회의에서부터 적극적으로 의견을 제시하며 팀의 방향성을 잡아주셨고, 논리적인 근거를 바탕으로 설득하여 팀의 합의가 원활히 이루어질 수 있도록 도와주셨습니다. 특히 논리모델링 단계에서 데이터 구조의 뼈대를 잡아주신 점은 전체 개발에 큰 기여가 되었고, ERD 설계에서도 팀원들이 놓친 부분을 짚어주셔서 더욱 견고한 결과물이 나올 수 있었습니다. 기능 구현뿐 아니라 설계와 의사결정 전반에서 적극적인 역할을 수행하셨습니다. |
...
| 최혜원 | 승건님은 목격제보 게시판, 회원 관련 기능의 이벤트 스케줄러와 트리거를 구현해 서비스가 실제로 운영 가능한 수준으로 발전하는 데 큰 기여를 하셨습니다. 단순 CRUD 기능을 넘어, 신고 누적 시 블라인드 처리나 봉사왕 집계 같은 자동화 로직을 구축하여 서비스의 신뢰성과 실용성을 높였습니다. 또한 이벤트 스케줄러를 통해 월별 봉사 횟수 초기화 등 주기적인 작업을 자동화하여 관리자의 개입 없이도 안정적인 서비스 운영이 가능하게 만들었습니다. 논리모델링 과정에서도 데이터 구조와 관계를 명확히 정의해 개발의 토대를 마련해주셨고, 코드 흐름과 구조를 깊이 이해하고 계셔서 댕냥쉼터의 서비스 품질을 끌어올리는 핵심적인 역할을 해주셨습니다. |
...
| 최혜원 | 지윤님은 자유게시판, 보호소장 회원 기능을 통해 댕냥쉼터의 서비스에 기여를 하셨고, 프로젝트 초반 회의에서 중간 내용을 정리해주셔서 회의가 산만해지지 않고 명확한 방향성을 유지할 수 있었고, 필요할 때는 적절한 질문을 통해 합의점을 이끌어내며 팀의 흐름을 안정적으로 잡아주셨습니다. 또한 승건님과 함께 패키지 구조를 고민하고 정리하여 코드가 일관성과 유지보수성을 갖추도록 크게 기여하셨습니다. 마지막으로 발표를 직접 맡아 명확한 설명으로 프로젝트의 성과를 외부에 잘 전달하며 팀을 대표해주셨습니다. |
